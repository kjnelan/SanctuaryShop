        ...
        <div class="col-md-8">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="mb-3"><label class="form-label fw-semibold" for="shipping_methods"><?php echo Text::_('COM_SANCTUARYSHOP_CONFIG_SHIPPING_METHODS'); ?></label><textarea class="form-control" id="shipping_methods" name="shipping_methods" rows="5" placeholder="standard|Standard Shipping|5|0.50&#10;priority|Priority Shipping|12|1.00"><?php echo $this->escape($p->get('shipping_methods', '')); ?></textarea><div class="form-text"><?php echo Text::_('COM_SANCTUARYSHOP_CONFIG_SHIPPING_METHODS_NOTE'); ?></div></div>
                    <div class="mb-3"><label class="form-label fw-semibold" for="shipping_weight_rules"><?php echo Text::_('COM_SANCTUARYSHOP_CONFIG_WEIGHT_RULES'); ?></label><textarea class="form-control" id="shipping_weight_rules" name="shipping_weight_rules" rows="5" placeholder="1=5&#10;5=8&#10;10=12"><?php echo $this->escape($p->get('shipping_weight_rules', '')); ?></textarea><div class="form-text"><?php echo Text::_('COM_SANCTUARYSHOP_CONFIG_WEIGHT_RULES_NOTE'); ?></div></div>
                    <div class="mb-3">
