...
class Com_SanctuaryshopInstallerScript
{
    ...
    private function createTables($parent = null)
    {
        ...
        $tables = [
            ...
            "{$prefix}sanctuaryshop_refunds" => "
                CREATE TABLE IF NOT EXISTS `{$prefix}sanctuaryshop_refunds` (
                    `id`                INT UNSIGNED NOT NULL AUTO_INCREMENT,
                    ...
                    PRIMARY KEY (`id`),
                    UNIQUE KEY `idx_square_refund` (`square_refund_id`),
